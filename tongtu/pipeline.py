...
STAGE_OUTPUTS: dict[str, tuple[Callable[[Workdir], Path], ...]] = {
    ...
    "precompile": (lambda w: w.precompile_tex, lambda w: w.sandbox("precompile") / "flat.pdf"),
...
STAGE_REMOVES: dict[str, tuple[Callable[[Workdir], Path] | str, ...]] = {
    ...
    "precompile": (lambda w: w.sandbox("precompile"), lambda w: w.precompile_tex, lambda w: w.precompile_fix_log),
    "mask": (lambda w: w.masked, lambda w: w.blocks),
